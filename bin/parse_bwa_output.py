...
def parse_bwa_output(flagstat_file, idxstats_file, output_file, reference_file, report_file, MAPPED_THRESHOLD):
    """Parse flagstat file."""
...
def main(argv=None):
    ...
    parse_bwa_output(args.flagstat_file, args.idxstats_file, args.output_file, args.reference_file, args.report_file, args.mapped_threshold)
